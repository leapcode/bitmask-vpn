...
// NewHTTPClient creates a new menshen API HTTP client.
func NewHTTPClient(formats strfmt.Registry) *MenshenAPI {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new menshen API HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *MenshenAPI {
...
// New creates a new menshen API client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *MenshenAPI {
	// ensure nullable parameters have default
	if formats == nil {
